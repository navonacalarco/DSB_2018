...
class BowlConfig(Config):
    ...
    ASPECT_RATIO = 1.5 # This has changed
    MIN_ENLARGE = 1.5 # This has changed
    ZOOM = 1.7 This has changed
    IMAGE_MIN_SCALE = False 

    ROT_RANGE = 22.5 # This has changed
    CHANNEL_SHIFT_RANGE = 20 # This has changed
    LEARNING_RATE = 0.001
...
## Mode weights from last epoch of train step 2
model_path = os.path.join(MODEL_DIR,'002','final.h5') 
